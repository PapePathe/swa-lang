...
const std::unordered_map<std::string, TokenType> KEYWORDS_ENGLISH = {
    {"const", TokenType::CONST},     {"dialect", TokenType::DIALECT},
    {"func", TokenType::FUNCTION},   {"else", TokenType::ELSE},
    {"if", TokenType::IF},           {"while", TokenType::WHILE},
    {"start", TokenType::MAIN},      {"print", TokenType::PRINT},
    {"print_f", TokenType::PRINT_F}, {"return", TokenType::RETURN},
    {"struct", TokenType::STRUCT},   {"let", TokenType::LET},
    {"int", TokenType::INT},         {"int64", TokenType::INT},
    {"byte", TokenType::BYTE},       {"error", TokenType::ERROR},
    {"float", TokenType::FLOAT},     {"string", TokenType::STRING},
    {"bool", TokenType::BOOL},       {"and", TokenType::AND},
    {"or", TokenType::OR},           {"true", TokenType::TRUE},
    {"false", TokenType::FALSE},     {"variadic", TokenType::VARIADIC},
    {"main", TokenType::MAIN},       {"zero", TokenType::ZERO}};
